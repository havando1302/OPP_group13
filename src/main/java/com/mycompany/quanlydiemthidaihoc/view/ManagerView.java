...
public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int col) {
    ...
    private void initComponents() {
        ...
        setTitle("Quản lý thi sinh với hệ thống quản lý điểm thi đại học");
        ...
        btnSortByName.setBounds(450, 330, 150, 40);
        ...
        btnStatistic.setBounds(900, 330, 150, 40);
        ...
        btnSortByYear.setBounds(670, 330, 180, 40);
        ...
        btnSortByID.setBounds(250, 330, 150, 40);
        //btnSortByID.setOpaque(false);
        ...
        jLabel13.setText("Tổng số học sinh:");
        ...
        btnImage.setIcon(new ImageIcon("src/main/java/com/mycompany/quanlydiemthidaihoc/view/green pin.png"));
        ...
        BirthdayChooser.setBounds(300, 180, 180, 40);
    ...
    public void showSpecialPerson(ThiSinh specialPerson) 
{
   ...
   public ThiSinh getSpecialPersonInfo() {
    ...
    public void showStatisticTypeSpecialPersons(List<ThiSinh> list) {
        //tableStatistic=new JTable();
        lblTable.setText("Thống kê số lượng theo khối");
        lblChart.setText("Biểu đồ thống kê số lượng theo loại khối");
        chart1.clear();
        int size1 = 18;
    ...
    public void showStatisticAgeSpecialPersons(List<ThiSinh> list) {
